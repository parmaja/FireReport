          ...
          begin
            ...
            begin
              for i1 := 1 to Length(s1) do
                if s1[i1] in ['.', ','] then s1[i1] := FormatSettings.DecimalSeparator;
              nm[st] := StrToFloat(s1);
            end
            else
              if Assigned(FOnGetValue) then
