...
{
        converts a AnsiString from '321' to the internal representation '715'
...
function TBarcode.GetTypText: AnsiString;

const bcNames: array[bcCode_2_5_interleaved..bcCodeEAN13] of AnsiString =
  (
    ('2_5_interleaved'),
    ('2_5_industrial'),
    ('2_5_matrix'),
...
procedure TBarcode.OneBarProps(code: AnsiChar; var Width: integer; var lt: TBarLineType);
begin
  case code of
    AnsiChar('0'): begin width := modules[0]; lt := white; end;
...
function TBarcode.MakeData: AnsiString;
begin
...
begin
  ...
  for i := 1 to Length(data) do // examine the pattern AnsiString
  begin
...
//       L1   S1   L2   S2
const tabelle_EAN_A: array['0'..'9', 1..4] of AnsiChar =
  (
    ('2', '6', '0', '5'), // 0
    ('1', '6', '1', '5'), // 1
    ('1', '5', '1', '6'), // 2
...
//       S1   L1   S2   L2
const tabelle_EAN_C: array['0'..'9', 1..4] of AnsiChar =
  (
    ('7', '1', '5', '0'), // 0
    ('6', '1', '6', '0'), // 1
    ('6', '0', '6', '1'), // 2
...
function TBarcode.Code_EAN8: AnsiString;
var
  i, j: integer;
  tmp: AnsiString;
begin
...
//       L1   S1   L2   S2
const tabelle_EAN_B: array['0'..'9', 1..4] of AnsiChar =
  (
    ('0', '5', '1', '7'), // 0
    ('0', '6', '1', '6'), // 1
    ('1', '6', '0', '6'), // 2
...
function TBarcode.Code_EAN13: AnsiString;
var
  i, j, LK: integer;
  tmp: AnsiString;
begin
...
function TBarcode.Code_2_5_interleaved: AnsiString;
var
  i, j: integer;
  c: AnsiChar;
...
function TBarcode.Code_2_5_industrial: AnsiString;
var
  i, j: integer;
begin
...
function TBarcode.Code_2_5_matrix: AnsiString;
var
  i, j: integer;
  c: AnsiChar;
begin
...
function TBarcode.Code_39: AnsiString;
...
function TBarcode.Code_39Extended: AnsiString;
...
function TBarcode.Code_128: AnsiString;
type TCode128 =
  record
    a, b: AnsiChar;
    c: string[2];
...
function TBarcode.Code_93: AnsiString;
type TCode93 =
  record
    c: AnsiChar;
...
function TBarcode.Code_93Extended: AnsiString;
...
function TBarcode.Code_MSI: AnsiString;
...
function TBarcode.Code_PostNet: AnsiString;
...
function TBarcode.Code_Codabar: AnsiString;
type TCodabar =
  record
    c: ansichar;
...
var
  i, idx: integer;
begin
  result := tabelle_cb[Find_Codabar('A')].data + AnsiChar('0');
  for i := 1 to Length(FText) do
  begin
...
procedure TBarcode.DoLines(data: AnsiString; Canvas: TCanvas);
